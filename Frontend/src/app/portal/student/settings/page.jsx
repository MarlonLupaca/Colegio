...
export default function SettingsPage() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const codigoUsuario = 'AL20260001'; 
    ...
    <div className="w-full max-w-xl mx-auto space-y-6 animate-fade-in pb-12 text-xs text-[#031553]">
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex items-center gap-4">
        ...
        <div>
          ...
          <h2 className="text-sm font-extrabold text-[#031553]">Roberto Gómez Alva</h2>
          <p className="text-[10px] text-gray-500 font-mono mt-0.5">Código Estudiante: AL20260001</p>
        </div>
      </div>
